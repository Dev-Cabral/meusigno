...
<div class="container mt-5 text-center">
    ...
    if (!$signo_encontrado) {
        echo "<p style='color: black;'>Não foi possível determinar seu signo. Verifique a data informada.</p>";
    }
    ?>
    
    <a href="index.php" class="btn" style="background-color:rgb(255, 0, 157); color: white; border-radius: 25px; width: 100px;">Voltar</a>
